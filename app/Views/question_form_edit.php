        ...
        <form action="<?= base_url("package/$package_id/question/save") ?>" method="post">
            ...
            <div class="card-body">
                <div class="form-group row d-none">
                    ...
                    <div class="col-lg-3">
                        <input name="question_type" id="question_type" type="text" class="form-control" readonly value="<?= '1' ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label" for="correct_option_id">Correct Answer</label>
                    <div class="col-lg-9">
                        <input name="correct_option_id" id="correct_option_id" type="text" class="form-control" value="<?= old('correct_option_id') ? old('correct_option_id') : $correct_option_id ?>">
                    </div>
                </div>
            </div>
            <div class="card-footer">
                <a href="<?= base_url("package/$package_id") ?>" class="btn btn-info"><i class="fas fa-fw fa-arrow-circle-left"></i> Kembali</a>
